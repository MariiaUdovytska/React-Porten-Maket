				...
				<div className='collections__body'>
					...
					<div className='collections__body-right'>
						<div className='collections__body-right-content'>
							<h2 className='collections__body-right-content-title titleM'>коллекция 2018</h2>
							...
							<button type='submit' className='collections__body-right-content-btn'>посмотреть коллекцию</button>
						</div>
					</div>
				</div>
			</section>
