						...
						<div className='footer__body'>
							...
							<div className='footer__body-center'>
								...
								<div className='footer__body-center-btns'>
									<span><button type='submit' className='footer__body-center-btns-btn'>часы</button></span>
									<span><button type='submit' className='footer__body-center-btns-btn'>браслеты</button></span>
									
									<span><button type='submit' className='footer__body-center-btns-btn'>ремни</button></span>
									<span><button type='submit' className='footer__body-center-btns-btn'>ювелирные изделия</button></span>
									<span><button type='submit' className='footer__body-center-btns-btn'>запонки</button></span>
								</div>
							</div>
